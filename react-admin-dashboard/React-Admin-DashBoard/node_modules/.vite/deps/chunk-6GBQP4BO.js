...
function rgbSpline(spline) {
  return function(colors3) {
    var n = colors3.length, r2 = new Array(n), g = new Array(n), b = new Array(n), i, color2;
    for (i = 0; i < n; ++i) {
...
function useLineSeries() {
  const series = useSeries();
  return React8.useMemo(() => series.line, [series.line]);
}
...
function useScatterSeries() {
  const series = useSeries();
  return React8.useMemo(() => series.scatter, [series.scatter]);
}
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(React24.Fragment, {
...
true ? BarLabelPlot.propTypes = {
  ...
  bars: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    ...
    maskId: import_prop_types6.default.string.isRequired,
    ...
    xOrigin: import_prop_types6.default.number.isRequired,
    y: import_prop_types6.default.number.isRequired,
    yOrigin: import_prop_types6.default.number.isRequired
  })).isRequired,
...
function usePluginsMerge(plugins) {
  ...
  return React31.useMemo(() => {
    ...
    const xExtremumGetters2 = {};
    const yExtremumGetters2 = {};
    for (let i = 0; i < defaultizedPlugins.length; i += 1) {
      ...
      if (plugin5.xExtremumGetter) {
        xExtremumGetters2[plugin5.seriesType] = plugin5.xExtremumGetter;
      }
      if (plugin5.yExtremumGetter) {
        yExtremumGetters2[plugin5.seriesType] = plugin5.yExtremumGetter;
      }
    }
    return {
      seriesFormatters,
      colorProcessors,
      xExtremumGetters: xExtremumGetters2,
      yExtremumGetters: yExtremumGetters2
    };
  }, [defaultizedPlugins]);
}
    ...
    children: (0, import_jsx_runtime17.jsx)(SeriesContextProvider, {
      ...
      children: (0, import_jsx_runtime17.jsx)(CartesianContextProvider, {
        ...
        children: (0, import_jsx_runtime17.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime17.jsx)(HighlightedProvider, {
            highlightedItem,
            onHighlightChange,
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React33.useRef(false);
  const [width, setWidth] = React33.useState(0);
  const [height, setHeight] = React33.useState(0);
...
var ResponsiveChartContainer = React34.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  ...
  return (0, import_jsx_runtime18.jsx)(ResizableContainer, {
    ...
    children: width && height ? (0, import_jsx_runtime18.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
function ChartsText(props) {
  ...
  const wordsByLines = React35.useMemo(() => getWordsByLines({
    style,
...
function ChartsXAxis(inProps) {
  const {
    xAxisIds,
    xAxis
  } = React37.useContext(CartesianContext);
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime22.jsxs)(React39.Fragment, {
...
function getColor5(series, xAxis, yAxis, zAxis) {
  if (xAxis !== void 0 && yAxis !== void 0) {
    ...
    if (series.type === "scatter") {
      return getColor2(series, xAxis, yAxis, zAxis);
    }
  }
  if (series.type === "pie") {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types16.default.shape({
    classes: import_prop_types16.default.object,
    getColor: import_prop_types16.default.func,
    itemData: import_prop_types16.default.shape({
      ...
      type: import_prop_types16.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types16.default.object,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React44.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React44.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types18.default.shape({
    x: import_prop_types18.default.shape({
      index: import_prop_types18.default.number,
      value: import_prop_types18.default.oneOfType([import_prop_types18.default.instanceOf(Date), import_prop_types18.default.number, import_prop_types18.default.string]).isRequired
    }),
    y: import_prop_types18.default.shape({
      index: import_prop_types18.default.number,
      value: import_prop_types18.default.oneOfType([import_prop_types18.default.instanceOf(Date), import_prop_types18.default.number, import_prop_types18.default.string]).isRequired
    })
  }).isRequired,
  ...
  contentProps: import_prop_types18.default.shape({
    axis: import_prop_types18.default.object,
    axisData: import_prop_types18.default.shape({
      x: import_prop_types18.default.shape({
        index: import_prop_types18.default.number,
        value: import_prop_types18.default.oneOfType([import_prop_types18.default.instanceOf(Date), import_prop_types18.default.number, import_prop_types18.default.string]).isRequired
    ...
    axisValue: import_prop_types18.default.oneOfType([import_prop_types18.default.instanceOf(Date), import_prop_types18.default.number, import_prop_types18.default.string]),
    classes: import_prop_types18.default.object,
    dataIndex: import_prop_types18.default.number,
    series: import_prop_types18.default.arrayOf(import_prop_types18.default.object),
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React46.useMemo(
  ...
  const padding = React46.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React46.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React46.useMemo(() => {
    let x2 = 0;
    let y2 = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  drawingArea: import_prop_types20.default.shape({
    bottom: import_prop_types20.default.number.isRequired,
    height: import_prop_types20.default.number.isRequired,
    left: import_prop_types20.default.number.isRequired,
    right: import_prop_types20.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types20.default.arrayOf(import_prop_types20.default.shape({
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types23.default.shape({
...
function ChartsGrid(props) {
  ...
  const {
    ...
    yAxis,
    yAxisIds
  } = React50.useContext(CartesianContext);
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(React51.Fragment, {});
}
...
//# sourceMappingURL=chunk-6GBQP4BO.js.map
